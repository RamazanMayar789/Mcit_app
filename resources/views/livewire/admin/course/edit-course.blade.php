<div>
    ...
    <flux:modal name="edit-course" class="md:w-[800px]" :dismissible="false" variant="flyout" position="bottom">
        <div class="space-y-6">
            <div>
            ...
            <flux:button type="submit" wire:click="update" variant="primary">ثبت</flux:button>
