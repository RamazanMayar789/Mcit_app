<div>
    ...
    <flux:modal name="edit-student" class="md:w-[800px]" :dismissible="false" variant="flyout" position="bottom">
        <div class="space-y-6">
            <div>
                <flux:heading class="mt-4 text-green-600" size="lg">ویرایش کردن شاگردان</flux:heading>
                <flux:text class="mt-2 text-pink-800">معلومات شاگردان ویرایش نماید.</flux:text>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2 grid md:grid-cols-[2fr_1fr] gap-2 items-end">
                    ...
                    <flux:button type="submit" wire:click="update" variant="primary" class="w-full">ویرایش</flux:button>
                    </div>
                   </div>
        </div>
    </flux:modal>
